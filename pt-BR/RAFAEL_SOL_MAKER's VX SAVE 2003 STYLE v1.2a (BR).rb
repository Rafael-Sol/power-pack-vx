...
#-------------------------------------------------------------------------------
# Descrição:    Possibilita o aumento do número de saveslots (slots para salvar 
#               o jogo) do padrão, que são somente 4, para o número desejado.
#               Também modifica a cena para que ela se pareça mais com a do
#               RPG Maker 2003 exibindo as faces dos personagens e o dinheiro.
#               Compatível com as resoluções de 544x416 e 640x480.
#-------------------------------------------------------------------------------
# Modo de usar: Configure o número de slots no módulo configurável.
#-------------------------------------------------------------------------------
# Agradecimentos Especiais: UNIR
#-------------------------------------------------------------------------------
#===============================================================================
...
# * Agora a cena de título pode carregar os arquivos salvos novamente...
#   (Cara, mas que mancada!)
# VX SAVE 2003 STYLE v1.1 -> v1.2
# * Agora o nome é gerado com dois dígitos, mesmo que seja menor que 10 
#     Ex.: 'Save01.rvdata'
# * Os saveslots ganharam sua pasta própria:(criada automaticamente, se preciso)
#     [Pasta raiz do jogo]/Saveslots/
#-------------------------------------------------------------------------------
#===============================================================================

module PowerPackVX_General_Configs  
  # AJUSTES BÁSICOS DOS SISTEMAS
  Total_Saveslots = 15  # Número máximo de slots para salvar  
end
...
# Window_SaveFile
#------------------------------------------------------------------------------
# Exibe a tela dos arquivos de saves e permite carregar e salvar um arquivo.
#==============================================================================
